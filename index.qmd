...
<div class="ld-hero-mark">
  <svg class="ld-mark-svg" viewBox="0 0 220 180" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="LabDados">
    <!-- L outline -->
    <path class="outline" d="M22,18 L22,158 L130,158"/>
    <!-- D outline -->
    <path class="outline" d="M138,18 L160,18 C195,18 210,52 210,88 C210,124 195,158 160,158 L138,158 Z"/>
    <!-- 3x3 grid of square "data" dots inside the L -->
    <g>
      <rect class="dot" data-pos="0,0" x="40"  y="40"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="0,1" x="68"  y="40"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="0,2" x="96"  y="40"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="1,0" x="40"  y="68"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="1,1" x="68"  y="68"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="1,2" x="96"  y="68"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="2,0" x="40"  y="96"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="2,1" x="68"  y="96"  width="20" height="20" rx="3"/>
      <rect class="dot" data-pos="2,2" x="96"  y="96"  width="20" height="20" rx="3"/>
    </g>
  </svg>
